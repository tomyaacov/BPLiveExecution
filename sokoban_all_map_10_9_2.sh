...
#SBATCH --job-name 0_map_10_9_2 ### name of the job. replace my_job with your desired job name
...
~/.conda/envs/BPLiveExecution/bin/python ~/repos/BPLiveExecution/main_sokoban.py "map_10_9_2" "0"
