...
#SBATCH --job-name sokoban0 ### name of the job. replace my_job with your desired job name
#SBATCH --output sokoban0.out ### output log for running job - %J is the job number variable
...
#SBATCH --mem=8G ### total amount of RAM
#SBATCH --ntasks=1
