...
#SBATCH --job-name sokoban2 ### name of the job. replace my_job with your desired job name
#SBATCH --output sokoban2.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPLiveExecution/bin/python ~/repos/BPLiveExecution/main_sokoban_2.py 2