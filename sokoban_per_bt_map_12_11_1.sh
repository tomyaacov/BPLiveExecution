...
#SBATCH --job-name 1_map_12_11_1 ### name of the job. replace my_job with your desired job name
#SBATCH --output 1_map_12_11_1.out ### output log for running job - %J is the job number variable
