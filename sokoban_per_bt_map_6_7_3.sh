...
#SBATCH --job-name 1_map_6_7_3 ### name of the job. replace my_job with your desired job name
#SBATCH --output 1_map_6_7_3.out ### output log for running job - %J is the job number variable
